...
*   Modify the code such that only primary vertices are accepted within 10 cm of detector center. Selections such as these in the event sample or track sample are often referred to as ‘cuts’. 
